    ...
    <div className="bg-[url('/placeholder_background.jpg')] bg-cover h-[350px] w-full">
      <GlobalWidth>
        <div className="flex flex-wrap gap-4 w-full text-primary-dark pt-[100px]">
          <div className="flex-1 flex flex-col gap-6 bg-white border-[1px] border-border_gray p-8 rounded-lg">
          ...
          <div className="md:flex-2 w-full md:w-fit flex flex-col gap-6 bg-white border-[1px] border-border_gray p-8 rounded-lg">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex gap-8 items-center justify-between px-5 py-2 bg-[#FFD157] rounded-lg cursor-pointer w-full md:w-fit font-light">
                Bel: 06-53549588
              </div>
