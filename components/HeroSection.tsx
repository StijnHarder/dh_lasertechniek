...
export const HeroSection = () => {
  return (
    <div className="flex gap-x-4 pt-[100px] items-start gap-4 w-full h-[350px] px-20 bg-[url('/placeholder_background.jpg')] bg-cover">
      <div className="flex-1 flex flex-col gap-6 h-fit bg-white text-[#454A63] border-[1px] border-[#E8E8E8] p-8 rounded-lg">
        ...
        <div className="flex gap-8 items-center justify-between px-5 py-2 bg-[#FFD157] rounded-lg cursor-pointer w-max font-light">Producten</div>
      </div>
      <div className="flex-2 flex flex-col gap-5 p-6 text-[#454A63] bg-[#FFFFFF] border-[1px] border-[#E8E8E8] h-fit rounded-lg">
        <div className="flex gap-4 items-center">
            ...
            <div className="rounded-full bg-[#FFD157] p-3">
                <Image src={"/avatar.svg"} width={50} height={50} alt="avatar image"/>
            </div>
        </div>
        <div className="flex flex-col gap-1">
            <div className="flex gap-8 items-center justify-between px-5 py-2 bg-[#FFD157] rounded-lg cursor-pointer w-fit font-light">Bel: 06-53549588</div>
            <div className="flex gap-8 text-white items-center justify-between px-5 py-2 bg-[#454A63] rounded-lg cursor-pointer w-fit font-light">Offerte aanvragen</div>
        </div>
